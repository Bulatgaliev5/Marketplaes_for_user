...
public partial class ViewIsbrannoe : ContentPage
{
    ViewModelIsbrannoe viewModel_Goods = new ViewModelIsbrannoe();
    public ViewIsbrannoe()
    {
    ...
    {
        if (sender is Image b && b.BindingContext is Isbrannoe g)
        {
